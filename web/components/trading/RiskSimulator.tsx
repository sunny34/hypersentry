                    ...
                    <>
                        ...
                        <div className="flex-1 bg-gray-900/50 border border-gray-800 rounded-xl p-4 min-h-[400px]">
                            <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                                ...
                                {params.useHistorical ? `Historical Bootstrap (${params.token})` : 'Standard Monte Carlo'} - 50 Samples
                            </h3>
                            <ResponsiveContainer width="100%" height={350}>
                                <LineChart>
                                    ...
                                    <XAxis
                                        ...
                                        allowDuplicatedCategory={false} // Important for multi-line
                                    />
                                    <YAxis stroke="#9CA3AF" />
                                    <Tooltip
