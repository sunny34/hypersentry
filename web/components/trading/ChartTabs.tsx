    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-center gap-1 py-1.5 bg-black/20 border-b border-white/5">
                    ...
                    return (
                        ...
                        >
                            <Icon className={`w-3.5 h-3.5 ${isActive
                                    ? tab.id === 'liquidations' ? 'text-orange-400' :
                                        tab.id === 'stops' ? 'text-blue-400' : 'text-emerald-400'
                                    : ''
                                }`} />
                            <span>{tab.label}</span>
                            ...
                            {isActive && (
                                <div className={`
                                    ...
                                    ${tab.id === 'liquidations' ? 'bg-orange-500' :
                                        tab.id === 'stops' ? 'bg-blue-500' : 'bg-emerald-500'}
                                `} />
                            )}
                        </button>
                    );
                ...
                {/* Live indicator */}
                <div className="ml-4 flex items-center gap-1.5 px-2 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
