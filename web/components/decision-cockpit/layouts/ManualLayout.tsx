    ...
    return (
        <div className="flex-1 min-h-0 flex flex-col lg:grid lg:grid-cols-12 gap-0 overflow-y-auto lg:overflow-y-auto">
            ...
            <div className="lg:col-span-3 flex flex-col min-h-[280px] lg:min-h-0 lg:overflow-y-auto">
                ...
                {/* Signal Breakdown */}
                <div className="flex-1 min-h-[220px] lg:min-h-0 border-b border-gray-800">
                    <SignalBreakdown />
                </div>
                <div className="shrink-0 bg-gray-950/20 p-4 sm:p-6 flex flex-col justify-center text-gray-700 text-[10px] font-mono uppercase">
