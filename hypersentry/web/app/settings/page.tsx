                        ...
                        <div className="space-y-4">
                            ...
                            {keys.map(k => (
                                <div key={k.id} className="flex items-center justify-between p-4 bg-black/20 rounded-xl border border-gray-800/50 hover:border-gray-700 transition group">
                                    <div className="flex items-center gap-4">
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-lg ${k.exchange === 'binance' ? 'bg-[#FCD535] text-black shadow-[0_0_15px_rgba(252,213,53,0.2)]' : 'bg-[#00ff9d] text-black shadow-[0_0_15px_rgba(0,255,157,0.2)]'}`}>
